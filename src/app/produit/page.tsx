  ...
  return (
    <Scene>
      <TopBar
        ...
        right={<Breadcrumb items={["Femme", "Mailles", "Pull crème"]} />}
      />
      ...
      >
        ...
        <div style={{ width: capped(440), flex: "none", display: "flex", flexDirection: "column", gap: vmin(22) }}>
          <div style={{ display: "flex", flexDirection: "column", gap: vmin(12) }}>
            <div
              style={{
                fontSize: vmin(13),
                fontWeight: 600,
                letterSpacing: "var(--label-letter-spacing-wide)",
                textTransform: "uppercase",
            ...
            <div style={{ fontSize: vmin(44), fontWeight: 700, lineHeight: 1.06 }}>
              Pull crème brodé
            </div>
            <div style={{ display: "flex", alignItems: "baseline", gap: vmin(14) }}>
              <span style={{ fontSize: vmin(38), fontWeight: 700, lineHeight: 1 }}>35 €</span>
              <span
                style={{
                  fontSize: vmin(18),
                  fontWeight: 500,
          ...
          <div style={{ fontSize: vmin(16), lineHeight: 1.6, color: "var(--text-on-scene-secondary)" }}>
            Maille douce en coton peigné, broderie ton sur ton au col. Coupe droite, tombé
            souple. Fabriqué en petite série.
          </div>
